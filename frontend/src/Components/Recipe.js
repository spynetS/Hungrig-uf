...
export default function Recipe(props){
  ...
  return (
    <div id={props.recipe.title} className="bg-white rounded-lg shadow-lg p-3" >
        <Loading on={loading} />
        ...
        <div className="grid md:grid-cols-4 md:grid-rows-1 grid-cols-3 grid-rows-2" >
            <div className="flex flex-col col-span-2 pr-2 w-full" >
              <div className="flex flex-row gap-2" >
                <img alt={"Bild Saknas"} className="flex items-center justify-center text-3xl text-gray-600 italic bg-gray-200 rounded-md w-2/3 aspect-video" src={`${link}${props.recipe.image}`} />
                <div>
